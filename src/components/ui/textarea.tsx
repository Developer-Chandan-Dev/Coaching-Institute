...
import { useMotionTemplate, useMotionValue, motion } from "framer-motion"; // Changed from 'motion/react'
  ...
  ({ className, ...props }, ref) => {
    ...
    return (
      ...
      `,
        ...
        className="group/textarea rounded-lg p-[2px] transition duration-300" // Changed group/input to group/textarea
      >
        <textarea
          className={cn(
